...
public:
    ...
    void plotGoalposeAndStair(ljh::heuclid::Pose3D<double> _goalPose);
    void plotSearchOutcome(std::vector<Location> _outcome,ljh::heuclid::Pose3D<double> _goalPose,ljh::heuclid::Pose3D<double> _startPose);
    void plotSearchOutcome2(std::vector<Location> _outcome,ljh::heuclid::Pose3D<double> _goalPose,ljh::heuclid::Pose3D<double> _startPose);
    void plotAccurateSearchOutcome(std::vector<AccurateFootstep> _outcome,ljh::heuclid::Pose3D<double> _goalPose,ljh::heuclid::Pose3D<double> _startPose);
    void plotAccurateSearchOutcome2(std::vector<AccurateFootstep> _outcome,ljh::heuclid::Pose3D<double> _goalPose,ljh::heuclid::Pose3D<double> _startPose,ljh::path::footstep_planner::Simple2DBodyPathHolder pathHolder);
#endif
};
