...
{
private:
    ljh::heuclid::Pose2D<double> startPose;
    ljh::heuclid::Pose2D<double> goalPose;
    std::vector<ljh::heuclid::Pose2D<double> > wayPointsAlongPath;
...
public:
    ...
    Simple2DBodyPathHolder(ljh::heuclid::Pose2D<double> _startPose,ljh::heuclid::Pose2D<double> _goalPose):startPose(_startPose),goalPose(_goalPose),
                                                    wayPointsAlongPath(),distance(0.0),x0(0.0),y0(0.0),xc(0.0),yc(0.0),a(0.0),b(0.0),maxX(0.0),maxY(0.0),minX(0.0),minY(0.0),dense(0){};

    void initialize(ljh::heuclid::Pose2D<double> _startPose,ljh::heuclid::Pose2D<double> _goalPose);                                                                                    
